...
public class FireController extends SimpleController {
	...
	public FireController(Map<String, String> parameters) throws InstantiationException,
	...
	@Override
	protected Cell newState(Cell[][] newGrid, Cell cell, String hoodState, int r, int c)
